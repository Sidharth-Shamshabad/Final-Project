    ...
    <WRow className='table-entry'>
      ...
      <WCol size='2'>
        {editingStatus ? (
          ...
          <div
            /*onClick={() => toggleStatusEdit(!editingStatus)}*/ className={`${completeStyle} table-text`}
          >
            {status}
          </div>
        )}
      ...
      <WCol size='3'>
        <div className='button-group'>
          <WButton
            className={
              canMoveUp ? 'table-entry-buttons' : 'table-entry-buttons-disabled'
            }
            onClick={
              canMoveUp ? () => props.reorderItem(data._id, -1) : disabledButton
            }
            wType='texted'
          >
          ...
          <WButton
            ...
            /*onClick={() => props.deleteItem(data, props.index)}*/ wType='texted'
          >
